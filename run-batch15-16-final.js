...
const BATCH_15_16_PAGES = [
  ...
  {
    batch: 15,
    route: "/settings/tax/exemptions",
    name: "Tax Exemptions"
  },
  {
    batch: 15,
    route: "/settings/tax/nexus",
    name: "Tax Nexus"
  },
  {
    batch: 15,
  ...
  {
    batch: 15,
    route: "/settings/verification/start",
...
async function runTests() {
  ...
  try {
    ...
    console.log('BATCH 17 - N/A: ' + batch17Results.filter(r => r.passed).length + '/' + batch17Results.length + ' passed');
