...
export default function TermsPage() {
  const lastUpdated = '7 December 2025';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
          ...
          <nav className="space-y-2">
            <a href="#agreement" className="block text-blue-600 hover:text-blue-800">1. Agreement to Terms</a>
            <a href="#description" className="block text-blue-600 hover:text-blue-800">2. Description of Service</a>
            <a href="#accounts" className="block text-blue-600 hover:text-blue-800">3. User Accounts</a>
            <a href="#acceptable-use" className="block text-blue-600 hover:text-blue-800">4. Acceptable Use</a>
            <a href="#ai-disclaimer" className="block text-blue-600 hover:text-blue-800">5. AI Assistant Disclaimer</a>
            <a href="#financial-disclaimer" className="block text-blue-600 hover:text-blue-800">6. Financial Information Disclaimer</a>
            <a href="#tax-disclaimer" className="block text-blue-600 hover:text-blue-800">7. Tax Filing Disclaimer</a>
            <a href="#third-party" className="block text-blue-600 hover:text-blue-800">8. Third-Party Services</a>
            <a href="#intellectual-property" className="block text-blue-600 hover:text-blue-800">9. Intellectual Property</a>
            <a href="#billing" className="block text-blue-600 hover:text-blue-800">10. Subscription & Billing</a>
            <a href="#liability" className="block text-blue-600 hover:text-blue-800">11. Limitation of Liability</a>
            <a href="#indemnification" className="block text-blue-600 hover:text-blue-800">12. Indemnification</a>
            <a href="#termination" className="block text-blue-600 hover:text-blue-800">13. Termination</a>
            <a href="#disputes" className="block text-blue-600 hover:text-blue-800">14. Dispute Resolution</a>
            <a href="#changes" className="block text-blue-600 hover:text-blue-800">15. Changes to Terms</a>
            <a href="#contact" className="block text-blue-600 hover:text-blue-800">16. Contact Information</a>
          </nav>
        </div>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section id="ai-disclaimer" className="mb-12">
            <div className="bg-red-50 border-2 border-red-300 rounded-lg p-6">
              ...
              <div className="text-slate-900 space-y-4 font-medium">
                <p className="text-lg">
          ...
          <section id="third-party" className="mb-12">
            ...
            <div className="text-slate-700 space-y-4">
              ...
              <p>
                When you connect your bank accounts through the Service, you authorize us to access your financial data through our third-party banking service providers. You acknowledge that:
              </p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section id="intellectual-property" className="mb-12">
            ...
            <div className="text-slate-700 space-y-4">
              <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">
                9.1 Operate's Intellectual Property
              </h3>
              <p>
          ...
          <section id="liability" className="mb-12">
            <div className="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-6">
              ...
              <div className="text-slate-700 space-y-4">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">
                  11.4 No Liability for AI Errors
                </h3>
                <p className="font-semibold">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mt-6 mb-3">
                  11.5 No Liability for Financial Decisions
                </h3>
                <p className="font-semibold">
          ...
          <section id="contact" className="mb-12">
            ...
            <div className="text-slate-700 space-y-4">
              ...
              <div className="bg-slate-100 border border-slate-300 rounded-lg p-6 my-4">
                <p className="font-semibold mb-2">Operate</p>
                <p>Email: <a href="mailto:support@operate.guru" className="text-blue-600 hover:text-blue-800">support@operate.guru</a></p>
                <p>Website: <a href="https://operate.guru" className="text-blue-600 hover:text-blue-800">https://operate.guru</a></p>
              </div>
              <p>
          ...
          <section className="bg-slate-100 border-2 border-slate-300 rounded-lg p-6 mb-12">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">
              Acknowledgment
            </h2>
