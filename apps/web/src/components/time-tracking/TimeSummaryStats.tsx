  ...
  const stats = [
    {
      ...
      billable: summary.billableToday ?? 0,
      nonBillable: summary.nonBillableToday ?? 0,
      color: 'text-blue-400',
    ...
    },
    {
      title: 'This Week',
      icon: TrendingUp,
      total: summary.thisWeek ?? 0,
      billable: summary.billableThisWeek ?? 0,
      nonBillable: summary.nonBillableThisWeek ?? 0,
    ...
    },
    {
      title: 'This Month',
      icon: DollarSign,
      total: summary.thisMonth ?? 0,
      billable: summary.billableThisMonth ?? 0,
      nonBillable: summary.nonBillableThisMonth ?? 0,
