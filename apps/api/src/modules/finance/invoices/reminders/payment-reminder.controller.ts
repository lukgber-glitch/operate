...
export class PaymentReminderController {
  ...
  @RequirePermissions('invoices:read' as any)
  ...
  @RequirePermissions('invoices:write' as any)
  ...
  @RequirePermissions('invoices:delete' as any)
   ...
   */
  @Get('reminder-settings')
  @RequirePermissions('settings:read' as any)
  ...
  @RequirePermissions('settings:write' as any)
