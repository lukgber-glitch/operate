/**
 * AUD Formatter Service Tests
 */

import { Test, TestingModule } from '@nestjs/testing';
import { BadRequestException } from '@nestjs/common';
import { AUDFormatterService } from '../aud-formatter.service';

describe('AUDFormatterService', () => {
  let service: AUDFormatterService;

  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [AUDFormatterService],
    }).compile();

    service = module.get<AUDFormatterService>(AUDFormatterService);
  });
  ...
  describe('formatAmount', () => {
    describe('Basic formatting', () => {
      it('should format amount with A$ symbol', () => {
  ...
  describe('parseAmount', () => {
    describe('Valid parsing', () => {
      it('should parse A$1,234.56', () => {
        const parsed = service.parseAmount('A$1,234.56');
      ...
      it('should parse AU$1,234.56', () => {
        const parsed = service.parseAmount('AU$1,234.56');
        expect(parsed).toBe(1234.56);
      });
  ...
  describe('validate', () => {
    it('should validate correct AUD amounts for electronic', () => {
    ...
    it('should validate correct AUD amounts for cash', () => {
  ...
  describe('getFormattingExamples', () => {
    it('should return examples in all formats', () => {
      ...
      expect(examples.electronic).toBeDefined();
      expect(examples.cash).toBeDefined();
  ...
  describe('getCurrencyConfig', () => {
    it('should return AUD currency configuration', () => {
      ...
      expect(config.rounding.type).toBe('cash');
    });
  });
});
